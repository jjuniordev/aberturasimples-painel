<?php 
  ...
  if ($id_unidade != 1) {
      ...
      mysql_query("INSERT tb_email_queue SELECT null,(select email b from tb_usuarios a inner join tb_unidades b on a.id_unidade = b.id where b.id = ".$id_unidade." AND a.id_level != 5),'".$date."',".$valores[$i]);  
    ...
    for ($i=0; $i <= $tam_array; $i++) { 
      ...
      mysql_query("INSERT tb_email_queue SELECT null,'dev.aberturasimples@gmail.com','".$date."',".$valores[$i]); 
