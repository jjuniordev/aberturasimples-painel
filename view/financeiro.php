<?php  
	...
	function getAssinaturas() {
		$query = mysql_query("SELECT date_format(data_evento,'%d/%m/%Y') as data_f,id_assinatura FROM tb_iugu WHERE status = 1 and id_empresa = 2 ORDER BY data_evento DESC;");
...
<div class="ui inverted menu" id="submenu">
	...
	<a class="item" href="financeiro_ab.php">
	    Abertura Simples
  	</a>	
  	<a class="active item" href="financeiro.php">
	    Arena Factus
  	</a>	  
</div>
<div class="ui grid">
