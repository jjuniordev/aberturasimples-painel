...
$(function() {
 ...
 <div class="ui container">
	...
	<div class="ui two column grid">
		<div class="column">
			<h3 class="ui left aligned left floated header">
		      Enviados
		      <div class="sub header">Tabela de leads enviados para as unidades.</div>
		    </h3>
		</div>
	</div>
	...
	<div class="ui segment">
      ...
      <div class="twelve wide right floated right aligned column">
      	<div id="trocar-combo" class="ui left icon action small disabled input">      	
				  <input id="tags" type="text" placeholder="buscar unidades...">
				  <i class="sync alternate icon"></i>
				  <button id="btn-atribuir-leads" class="ui green small disabled button">Trocar Unidade</button>&nbsp;&nbsp;        
			  	</div>
...
<script type="text/javascript">
    ...
    $.ajax({
        url: '../model/ajaxAtribuirLead2.php',
        type: 'POST',
        data: {
          'nome': nome,
          'valores': values,
        ...
        beforeSend: function(){	
				$('#trocar-combo').addClass('disabled loading');		    
			  },
        success: function(data) { //Se a requisição retornar com sucesso, 
	        ...
	        setTimeout(function(){
		    	$('#trocar-combo').removeClass('disabled loading');
		    	$(window).attr('location','dispararEmail.php');
		    },100);
	    }
      });
	}
