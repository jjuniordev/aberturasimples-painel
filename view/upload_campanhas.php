...
<div id="ui grid">
    <div class="ui container">
        ...
        <div class="ui inverted menu" id="submenu">
            <a id="google" class="active item" href="upload_campanhas.php">
                Google
              </a>
            <a id="facebook" class="item" href="upload_campanhas_face.php">
                Facebook
              </a>
            </div>
            <form class="ui form" action="insert_campanhas.php" method="post" name="upload_excel" enctype="multipart/form-data">
                <fieldset>
